...
<div class="filter-conteiner">
	...
	<form method="GET" action="{{ route('products') }}" class="filter-content">
		...
		<div class="section-filter__body" style="padding-bottom: 35px;">
			...
			<div class="filters-price__inputs">
				<label class="filters-price__label">
					...
					<input type="text" name="price_from" value="{{ request()->price_from}}" class="filters-price__input" id="input-0">
					<span class="filters-price__text">₽</span>
				</label>
				<label class="filters-price__label">
					<span class="filters-price__text">до</span>
					<input type="text" name="price_to" value="{{ request()->price_to }}" class="filters-price__input" id="input-1">
					<span class="filters-price__text">₽</span>
				</label>
			</div>
		</div>
